(function (e, t) {
    ...
    function o(e) {
        var t;
        return e.documentShived ? e : (m.shivCSS && !d && (t = !!n(e, "main,article,aside,details,figcaption,figure,footer,header,hgroup,nav,section{display:block}audio{display:none}canvas,video{display:inline-block;*display:inline;*zoom:1}[hidden]{display:none}audio[controls]{display:inline-block;*display:inline;*zoom:1}mark{background:#FF0;color:#000}")), h || (t = !r(e)), t && (e.documentShived = t), e)
    }
    ...
    var m = {
        elements: p.elements || "main abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",
        shivCSS: p.shivCSS !== !1,
